...
const env = {
  ...
  // JWT Configuration
  jwtSecret: process.env.JWT_SECRET || "rwa-exchange-dev-secret-key-change-in-production",
  ...
  blockchainRpcUrl: process.env.BLOCKCHAIN_RPC_URL || "https://rpc.testnet.onechain.one",
  blockchainChainId: parseInt(process.env.BLOCKCHAIN_CHAIN_ID, 10) || 31337,
  ...
  emailFrom: process.env.EMAIL_FROM || "noreply@rwa-exchange.com",
